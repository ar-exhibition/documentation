  ...
  Als weiterer Asset Lieferant könnten beispielsweise Plattformen wie \textit{Sketchfab} eingesetzt werden. 
    ...
    \subsection{Content-Management-System}
      ...
      \subsubsection{Backend}
        ...
        Herauszuheben sind dabei die beiden Komponenten \textit{Content API} und \textit{Dateiverwaltung}. Eine ausführlichere Erläuterung der Datenbankinterkation folgt im nächsten Kapitel,
        ...
        Dieser JSON-String wird auf Anfrage generiert. Die Links zum Runterladen 
